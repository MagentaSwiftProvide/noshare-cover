...
impl EncPictureParameterBufferVP9 {
    ...
    pub fn new(
        ...
        Self(Box::new(bindings::VAEncPictureParameterBufferVP9 {
            ...
            skip_frames_size,
            va_reserved: Default::default(),
            // noshare-cover: новые libva (2.23+) добавили сюда поля (seg_id_block_size,
            // va_reserved8); POD-структура, остальное — нули, собирается со старыми и новыми
            // SAFETY: C-структура без указателей-инвариантов, нули — валидное значение.
